<!-- resources/js/Pages/HR/Vacancies/Create.vue -->
<script setup>
...
function submit() {
    ...
    const payload = {
        ...
        experience_years_required: minYears, // keep same behavior as before
    ...
    router.post("/hr/vacancies", payload, {
        onSuccess: () => showToast("Vacancy created successfully!", "success"),
        onError: () =>
            ...
            <section class="header-card">
                ...
                <div class="header-content">
                    <div class="header-left">
                        ...
                        <div>
                            <h1 class="header-title">Create New Vacancy</h1>
                            <p class="header-subtitle">
                                Fill in the job details for AI-powered candidate
                                matching
                            </p>
                        </div>
                    </div>
